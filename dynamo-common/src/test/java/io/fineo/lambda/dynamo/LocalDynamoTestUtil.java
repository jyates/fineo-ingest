...
public class LocalDynamoTestUtil {
  ...
  public void setConnectionProperties(Properties props) {
    ...
    props.setProperty(FineoProperties.DYNAMO_READ_LIMIT, "10");
    props.setProperty(FineoProperties.DYNAMO_WRITE_LIMIT, "10");
    props.setProperty(FineoProperties.DYNAMO_RETRIES, "1");
  }
