...
public class FineoProperties {
  ...
  public static final String DYNAMO_READ_LIMIT = "fineo.dynamo.ingest.limit.read";
  public static final String DYNAMO_WRITE_LIMIT = "fineo.dynamo.ingest.limit.write";
