 ...
 */
public class EndToEndTestRunner2 {

  private static final Log LOG = LogFactory.getLog(EndToEndTestRunner2.class);
  ...
  public EndToEndTestRunner2(LambdaClientProperties props, ResourceManager manager,
